...
describe('uuidv7withURNWrapper', () => {
  test('should wrap a valid UUIDv7 string with URN prefix', () => {
    ...
    expect(result).toBe('urn:uuid:01932820-4b90-7000-8000-000000000000');
  });
  ...
  test('should wrap real-world UUIDv7 example', () => {
    ...
    expect(result).toBe('urn:uuid:018fd8f9-8c00-7a4c-8a47-1a6d4b90f3a1');
  });
  ...
  test('should preserve original UUID case in URN wrapper', () => {
    ...
    expect(resultLower).toBe('urn:uuid:018fd8f9-8c00-7a4c-8a47-1a6d4b90f3a1');
    expect(resultUpper).toBe('urn:uuid:018FD8F9-8C00-7A4C-8A47-1A6D4B90F3A1');
  ...
  test('should handle UUIDv7 with all numeric hex characters', () => {
    ...
    expect(result).toBe('urn:uuid:01234567-89ab-7cde-8012-345678901234');
  });
  ...
  test('should handle UUIDv7 with all alphabetic hex characters', () => {
    ...
    expect(result).toBe('urn:uuid:abcdefab-cdef-7abc-bdef-abcdefabcdef');
  });
  ...
  test('should conform to RFC 4122 URN format', () => {
    ...
    expect(result?.startsWith('urn:uuid:')).toBe(true);
    expect(result?.includes(uuidv7)).toBe(true);
  });
